...
Now we should find the images for elements $S(u,\,v)$ as well.
...
We have to check that $F(u,v)$ satisfy the relations \eqref{add2}--\eqref{add3}.
The relations \eqref{add2} and \eqref{conj2} are immediately obvious.

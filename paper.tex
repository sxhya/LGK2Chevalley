...
First of all, we remind the reader the way how \cref{tm:lg-principle} is proved in~\cite{Tul,SCh}.
...
\begin{enumerate}
 \item The Steinberg group functor $\St(\Phi, -)$ satisfies Tulenbaev lifting property;
...
We now discuss how Tulenbaev's lifting property is proved.

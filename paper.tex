...
Verification of the fact that $\psi$ preserves relations \eqref{add0}, \eqref{ccf2} is similar to the above computation but is easier.
...
This is because only this smaller family of relations is actually used during the construction of $\psi$. \end{rk}

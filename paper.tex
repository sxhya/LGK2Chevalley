...
i.\,e. matrices $M$ such that there exists a $2\times n$ matrix $N$ satisfying $NM=\left(\begin{smallmatrix}1&0\\0&1\end{smallmatrix}\right)$.
...
Similarly to \ref{df:TulX} one can check that this definition does depend neither on the order of factors nor on the choice of decomposition for $u$.
\end{df}

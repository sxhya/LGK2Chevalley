...
The unstable analogue of the ``universality'' part of this theorem has been known since 1970's for $\Phi$ with rank $\ell \geq 5$ (or even $\ell \geq 4$ for $\Phi=\rA_\ell, \rB_\ell, \rC_\ell$), see \cite{St1, KaS}.
